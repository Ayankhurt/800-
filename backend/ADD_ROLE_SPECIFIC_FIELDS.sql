...
-- This fixes the error: "Could not find the 'company_name' column of 'profiles'"
...
CREATE INDEX IF NOT EXISTS idx_profiles_trade_specialization ON public.profiles(trade_specialization) WHERE trade_specialization IS NOT NULL;
